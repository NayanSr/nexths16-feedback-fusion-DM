...
//     planned: posts.filter((p) => p.status === "planned"),
//     in_progress: posts.filter((p) => p.status === "in_progress"),
//     completed: posts.filter((p) => p.status === "under_review"),
//   };

//   const totalVots = posts.reduce((acc, post) => acc + post.votes.length, 0);
//   const averageVotes =
//     posts.length > 0 ? Math.round(totalVots / posts.length) : 0;
...
//       <GradientHeader
//         title="Product Roadmap"
//         subtitle="See what we're woeking on, what's comming next, and traxk our progress"
//       />

//       {/*Stats Overview */}
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
//         <Card className="border-l-4 border-l-teal-800">
//           <CardContent className="pt-6">
//             <div className="flex items-center justify-between">
//               <div className="">
//                 <p className="text-sm text-muted-foreground">Total Features</p>
//                 <p className="text-3xl font-bold">{posts.length}</p>
//               </div>
//               <Target className="h-10 w-10 text-teal-800" />
//             </div>
//           </CardContent>
//         </Card>
...
//               <div className="">
//                 <p className="text-sm text-muted-foreground">Total Votes</p>
//                 <p className="text-3xl font-bold">{totalVots}</p>
//               </div>
...
//                 </p>
//               </div>
//               <TicketCheckIcon className="h-10 w-10 text-purple-600" />
//             </div>
//           </CardContent>
//         </Card>
...
//                 <p className="text-3xl font-bold">{averageVotes}</p>
//               </div>
//               <AlignVerticalDistributeCenter className="h-10 w-10 text-amber-600" />
//             </div>
//           </CardContent>
//         </Card>
//       </div>
...
//                 <div className="flex items-center justify-between mb-2">
//                   <div className="flex items-center gap-2">
//                     <Icon className={`w-5 h-5 ${group.textColor}`} />
//                     <h2 className={`text-lg font-semibold ${group.textColor}`}>
//                       {group.title}
//                     </h2>
//                   </div>
