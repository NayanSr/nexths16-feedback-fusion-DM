...
export default async function FeedbackPage() {
  // const syncCurrUser= await syncCurrentUser()
  // console.log("Current User: ",syncCurrUser)
      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex gap-4 justify-center pt-4">
            <Button
              // asChild
              size="lg"
              className="bg-white text-blue-600 hover:bg-gray-400"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="lg:col-span-3">
            <FeedbackList initialPosts={posts} userId={userId}></FeedbackList>
          </div>
        </div>
      </div>
    </>
